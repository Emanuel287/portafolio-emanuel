    ...
    <footer className="px-6 md:px-24 py-20 bg-bubble relative overflow-hidden fade-up shadow-kawaii">
      ...
      <div className="grid md:grid-cols-2 gap-10 relative z-10">
        <div>
          ...
          <p className="text-sakura text-lg">Email: emanuel.sancho@ucr.ac.cr</p>
          <p className="text-sakura text-lg mt-1">
            GitHub: 
            <a 
              href="https://github.com/Emanuel287" 
              target="_blank" 
              rel="noopener noreferrer"
              className="underline hover:text-sakuraDark transition ml-1"
            >
              github.com/Emanuel287
            </a>
          </p>
        </div>
        ...
        <div>
          ...
          <a 
            href="https://github.com/Emanuel287/PortafolioEmanuel.git" 
            target="_blank" 
            rel="noopener noreferrer"
